...
//this.sendButton(id, wm, text, apii.data, [[(action == 'add' ? lenguajeGB.smsCont13() : lenguajeGB.smsCont14()), (action == 'add' ? '.welgc' : '.welgc')], ['ðŸ’– Ser Verificado(a)', `.verify`]], null, {mentions: this.parseMention(text)})
//}}}
