...
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *تحزير* ⊱⚠️⊱╮\n\n` }
...
const smsUnreg = () => { return `\`\`\`¡¡أنت بحاجة إلى التسجيل لاستخدام هذا الأمر ، اكتب *#تسجيل*  للتسجيل!!\`\`\`` }
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: centerYUNAbot@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
