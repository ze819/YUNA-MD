...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By GataBot-MD por Gatadios* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By GataBot-MD por Gatadios* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By GataBot-MD por Gatadios* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By GataBot-MD por Gatadios* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By GataBot-MD por Gatadios* 🔥', 'status@broadcast')} 
break
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY GATABOT-MD POR GATADIOS 🔥', fkontaak)}
break   
