...
if (!args[0]) throw `*[❗] أدخل رابط انستغرام, مثال: ${usedPrefix + command}* https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link` 
try {
await m.reply(`*[❗] جاري تحميل... .*`)
switch (command) {        
case "instagramdl": case "instagram": case "igdl": case "ggg": 
...
break  
case "instagramdl2": case "instagram2": case "igdl2": case "ig":        
...
await await m.reply(`*[❗] خطأ ، يرجى المحاولة مرة أخرى ، إذا استمر الخطأ ، فجرب خيارا آخر ( ${usedPrefix}ig, ${usedPrefix}ig3)*`)
}}
