...
await conn.sendButton(m.chat, texto.trim(), wm, img, [[' التالي', `${usedPrefix + command}`], [lenguajeGB.smsConMenu(), `${usedPrefix}menu`]], m, frep)}   
  
if (command == 'frase2') { 
  
let list = (await axios.get(`https://raw.githubusercontent.com/ahmed1p7/master/src/JSON/frase2.json`)).data  
